...
# Load model
model = joblib.load("sleep_disorder_svm_model_v142.pkl")
...
X_test_sample = pd.DataFrame(input_data, columns=columns)
...
if st.button("Predict"):
    ...
    # Load full dataset to evaluate model (for visualization)
